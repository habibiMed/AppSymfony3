...
class Post
{
     ...
     * @var string
     *
     * @ORM\Column(name="slug", type="string", length=180)
     */
    private $slug;
     ...
     * @Assert\NotBlank(groups={"new"} , message="Merci de telecharger une image")
     * @Assert\File(mimeTypes={ "image/png", "image/jpeg" },mimeTypesMessage="le type {{ type }} est invalide, voicei les types autorisés {{ types }}")
     */
    private $image;
