...
class Category
{
    ...
    /**
     * @var string
     *@Assert\NotBlank(message="merci de noter une libelle")
    ...
    /**
     * @var string
     * @Assert\NotBlank(message="merci de noter une description")
    ...
    /**
     * @var string
     *@Assert\NotBlank(message="merci de noter un slug")
